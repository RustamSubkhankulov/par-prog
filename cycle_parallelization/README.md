...
Понятно, что условия Бернстайна нарушаются. Зависимость возникает, если имеет решение система уравнений _F(K) = G(Λ)_, где F — вектор-функция (``f1``, ..., ``fn``), а G — вектор функция (``g1``, ..., ``gn``). 
